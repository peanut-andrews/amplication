...
export class ProductResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [BalanceTransaction], { name: "shopTransaction" })
  @nestAccessControl.UseRoles({
  ...
  async findShopTransaction(
    ...
    const results = await this.service.findShopTransaction(parent.id, args);
  ...
  async getShop(@graphql.Parent() parent: Product): Promise<Shop | null> {
